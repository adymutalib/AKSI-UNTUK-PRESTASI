...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <a href="{{ route('pembina.create') }}" class="btn btn-success">Tambah Data</a>
      <div class="my-3 col-12 col-sm-8 col-md-5">
        <form action="" method="get">
          <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="Masukkan Nama" name="nama" aria-describedby="basic-addon1">
                ...
                <th scope="row">{{ $n }}</th>
                    ...
                    <td>
                      <div style="display: flex; gap: 10px;">
                        <a href="{{ route('pembina.edit', encrypt($user->id_pembina)) }}" class="btn btn-primary">Edit</a>
                        <form action="{{ route('pembina.destroy',$user->id_pembina) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
