      ...
      <div class="my-3 col-12 col-sm-8 col-md-5">
        <form action="" method="get">
          <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="Cari berdasarkan nama/ekstra" name="nama" aria-describedby="basic-addon1">
                ...
                <th scope="row">{{ $n }}</th>
                    ...
                    <td>
                      <div style="display: flex; gap: 8px;">
                        <a href="{{ route('siswa.edit',encrypt( $user->id_siswa)) }}" class="btn btn-primary">Edit</a>
