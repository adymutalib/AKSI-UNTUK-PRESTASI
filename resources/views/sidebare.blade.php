        ...
        <section class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-sm-6">
                    <h3 class="text-center mb-3">Pendaftaran</h3>


                    <form name="tambahanggota" action="#" method="post">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="row mb-3">
                            <label for="jurusan" class="col-sm-2 col-form-label">Ekstra</label>
                            <div class="col-sm-10">
                              <select class="form-select" aria-label="Defaul select exemple" id="jurusan" name="jurusan">
                                <option value="IT">Pramuka</option>
                                <option value="SI">Osis</option>
                                <option value="BD">PMR</option>
                              </select>
                            </div>
                          </div>
                    </form>
