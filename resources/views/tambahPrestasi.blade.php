  ...
  <body>
    ...
    <main>
      ...
      <div class="container mt-3">
        <div class="row">
            <div class="col">
                <h3 class="text-center">Tambah Data Prestasi</h3><br>
                <div class="container ">
                        ...
                        <div class="col-md-5">
                            <form action="{{ route('prestasi.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="lomba_input" name="lombaInput">
                                </div>
                                <div class="mb-3">
                                    <label for="juara_input" class="form-label">Juara</label>
                                    <input type="text" class="form-control" id="juara_input" name="juaraInput">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="tanggal_input" name="tanggalInput">
                                </div>
