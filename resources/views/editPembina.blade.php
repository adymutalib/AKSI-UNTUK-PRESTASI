  ...
  <body>
    ...
    <main>
      ...
      <div class="container mt-3">
        <div class="row">
            <div class="col">
                <h3 class="text-center">Edit Data Pembina</h3><br>
                <div class="container ">
                        ...
                        <div class="col-md-5">
                            <form action="{{ route('pembina.update', $pembina->id_pembina) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_input" name="namaInput" value="{{ $pembina->nama }}">
                                </div>
                                <div class="mb-3">
                                    <label for="nip_input" class="form-label">NIP</label>
                                    <input type="text" class="form-control" id="nip_input" name="nipInput" value="{{ $pembina->nip }}">
                                </div>
                                <div class="mb-3">
                                  <label for="jk_input" class="form-label">Jenis Kelamin</label>
                                  <input type="text" class="form-control" id="jk_input" name="jkInput" value="{{ $pembina->jenis_kelamin }}">
                                </div>
                                <div class="mb-3">
                                  <label for="ttl_input" class="form-label">TTL</label>
                                  <input type="text" class="form-control" id="ttl_input" name="ttlInput" value="{{ $pembina->ttl }}">
                                </div>
                                <div class="mb-3">
                                  <label for="nohp_input" class="form-label">No HP</label>
                                  <input type="text" class="form-control" id="nohp_input" name="nohpInput" value="{{ $pembina->no_telp }}">
                                </div>
                                <div class="row mx-2">
