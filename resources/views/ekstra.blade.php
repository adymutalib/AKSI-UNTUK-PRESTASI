  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Data Ekstrakurikuler</h1>
      </div>
      @if (session('success'))
      ...
      @endif
      <a href="{{ route('ekstra.create') }}" class="btn btn-success">Tambah Data</a>
      <div class="my-3 col-12 col-sm-8 col-md-5">
        <form action="" method="get">
          <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="Masukkan Ekstrakurikuler" name="ekstra" aria-describedby="basic-addon1">
          ...
          <tbody>
            ...
            <tr>
                <th scope="row">{{ $n }}</th>
                    ...
                    <td><center> <img src="{{ asset('storage/app/'. $item->image) }}" alt="" style="width: 100px"></center></td>
                    
                    <td>
                      <div style="display: flex; gap: 10px;">
                        <a href="{{ route('ekstra.edit',encrypt( $item->id_ekstra)) }}" class="btn btn-primary">Edit</a>
                        <form action="{{ route('ekstra.destroy',$item->id_ekstra) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
